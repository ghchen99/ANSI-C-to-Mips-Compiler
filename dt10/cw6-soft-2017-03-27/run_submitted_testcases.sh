...
for NAME in $EXPECTED ; do
    ...
    gcc $DRIVER -o $TESTDIR/${NAME}.elf  test_deliverable/testcases/test_${NAME}.c  test_deliverable/testcases/test_${NAME}_driver.c  2> $TESTDIR/${NAME}.compile.stderr
    if [[ $? -ne 0 ]]; then
